...
export const food = <i class="fa-solid fa-pot-food"></i>
...
export const rent = <i class="fa-solid fa-hotel"></i>
export const groceries = <i class="fa-solid fa-basket-shopping"></i>